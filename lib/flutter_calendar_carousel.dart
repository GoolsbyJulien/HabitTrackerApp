...
import 'package:goal_tracker/src/calendar_header.dart';
import 'package:goal_tracker/src/default_styles.dart';

import 'package:goal_tracker/src/weekday_row.dart';
...
class _CalendarState extends State<CalendarCarousel> {
  ...
  initState() {
    ...
    maxDate = widget.maxSelectedDate ?? DateTime(DateTime.now().year + 4, DateTime.now().month, DateTime.now().day);
              ...
              child: GridView.count(
                ...
                children: List.generate(totalItemCount,
                  ...
                  if (minDate != null &&
                    ...
                    isSelectable = false;
                  return renderDay(isSelectable, index, false, isToday, isPrevMonthDay, textStyle, defaultTextStyle, isNextMonthDay, isThisMonthDay, now);
                }),
              ),
            ),
          ),
